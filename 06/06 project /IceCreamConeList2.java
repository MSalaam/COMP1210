...
*/
   ...
   public IceCreamConeList2(String listNameIn, IceCreamCone[] iListIn, int numberOfConesIn)
   {
 ...
 /**
   ...
   */
   ...
   public double averageSurfaceArea() {
      ...
      double averageSurfaceArea = totalSurfaceArea() / numberOfCones;
 ...
 /**
   ...
   */
   public double averageVolume() {
      ...
      double averageVolume = totalVolume() / numberOfCones;
...
*/
   ...
   public IceCreamConeList2 readFile(String fileNameIn) 
      ...
      IceCreamConeList2 objects = new IceCreamConeList2(listName, myList, numberOfCones);
