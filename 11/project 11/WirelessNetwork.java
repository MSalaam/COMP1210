...
*@param fixedCostIn to set input variables
*
*/
   ...
   *@param fixedCostIn to set input to get in report
   *
   */
   ...
   */
   ...
   public int compareTo(WirelessNetwork comparison) {
      ...
      return this.toString().toLowerCase().compareTo(comparison.toString().toLowerCase());
   }
